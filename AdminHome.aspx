...
<head runat="server">
   <title>Agro Harvest Agriculture Category Flat Bootstrap Responsive Web Template | Home :: w3layouts</title>
<!-- for-mobile-apps -->
	...
	<div class="container">
		...
		<nav class="py-4 d-lg-flex">
			...
			<ul class="menu mt-md-2 ml-auto">
                ...
                <li class="mr-lg-4 mr-2"><a href="Upload.aspx">Upload</a></li>
                <li class="mr-lg-4 mr-2"><a href="ManagePred.aspx">Manage Prediction</a></li>
...
<%--<footer class="text-center">--%>
	<div class="container">
		...
		<%--<div class="w3l-copy text-center">
			<p class="text-da">© 2019 Agro Harvest. All rights reserved 
			</p>
		</div>--%>
		<!-- //copyright -->
	<%--</div>
